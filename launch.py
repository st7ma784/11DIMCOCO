...
def wandbtrain(config=None,dir=None,devices=None,accelerator=None,Dataset=None,project="16DIM",entity="st7ma784"):
...
def train(config={
    ...
    from model import LightningCLIPModule
    ...
    if Dataset is None:
        ...
        Dataset=DataModule(dir=dir,batch_size=config["batch_size"])
    if devices is None:
